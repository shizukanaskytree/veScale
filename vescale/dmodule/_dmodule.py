...
# import sys
# import socket
# import snoop #  pip install birdseye
# import datetime
...
# snoop.install(out=os.path.join(log_folder, f"parallelize_module-{timestamp}.log"))
# ################################################################################
...
class DModule:
    ...
    # @spy() # , watch_explode=['self'], depth=2 # place below the @staticmethod
    @staticmethod
